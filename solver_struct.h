...
#define PHASE_1_SEARCH_CHUNK_SIZE      (0x00040000)
#define PHASE_2_SEARCH_CHUNK_SIZE_CPU  (0x00000100)
#define PHASE_2_SEARCH_CHUNK_SIZE_GPU  (0x00400000)
#define PHASE_2_SEARCH_CHUNK_SIZE_HOST (0x00000080)
